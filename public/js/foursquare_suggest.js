(function( $ ) {
    ...
    $.fn.fs_suggest = function(options) {
        ...
        var defaults = {
            ...
            v : '20131110', //the date of the foursquare api version
        ...
        this.keyup(function(event) {
            ...
            if(justEntered.length >= 3) {
                ...
                opts.near = $("#"+opts.nearSelector).val() || "";
    ...
    function onEnterKey() {
        ...
        if(resultsListActive) {
            ...
            $("#venue").val($("#" + resultsList.attr("id") + " .selected").text());
    ...
    function addResultsList(el) {
        el.after("<div id='auto-complete'><ul id='fs_search_results'></ul></div>");
    ...
    function buildResultsList() {
        ...
        if(minivenues && minivenues.length > 0) {
            ...
            for (var i = 0; i < minivenues.length; i++) {
                ...
                results += "<li><a href='javascript:void(0)' id='" + v.id + "'>" + v.name + "</a></li>";
            }
        } else {
